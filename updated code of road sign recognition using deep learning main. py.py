...
for i in range(classes):
    path = os.path.join(cur_path,"D:\Road sign recognization by using deeep learning\dataset\Train", str(i))
...
class Ui_MainWindow(object):
    ...
    def classifyFunction(self):
        model = load_model('D:\Road sign recognization by using deeep learning\my_model.h5')
